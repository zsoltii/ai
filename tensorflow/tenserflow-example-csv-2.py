...
TRAIN_DATA_URL = "csv/sql-mysql-db-2.csv"
TEST_DATA_URL = "https://storage.googleapis.com/tf-datasets/titanic/eval.csv"

train_file_path = tf.keras.utils.get_file("sql-mysql-db.csv", TRAIN_DATA_URL)
...
# Get the shape of the dataset elements
input_spec, _ = train_data.element_spec

# Extract the input dimension
input_dimension = input_spec.shape[1]
